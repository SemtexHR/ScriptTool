...
export default function FormTag({ isVisible}) {
  ...
  return (
    <motion.div
      ...
      className="w-4/20 flex flex-col items-center gap-y-10  h-screen overflow-y-auto  bg-white dark:bg-form mt-7.5"
    >
      <h1 className="flextext-black dark:text-white text-3xl font-doto font-bold mt-10">
          Add Tag
      </h1>
      <form 
      ...
      className="flex flex-col w-full h-full items-center">
        <div className="flex flex-col items-center w-full space-y-4">
          <label htmlFor="tn" className=" text-black dark:text-white" autoComplete="off">
            Tag Name
          </label>
          <input
            type="text"
            ...
            placeholder="Routine"
            required
            className="bg-white text-black outline-none  w-2/3 h-10  drop-shadow-xl/25 p-2 rad"
          />
        </div>
        <button
          type="submit"
